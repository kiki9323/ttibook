...
// import useGetLimitNumber from '../../hooks/useGetLimitNumber';
...
//   const [pokeCachedId, setPokeCachedId] = useState(0);
...
//   // const { data: cachedPoint } = useGetLimitNumber(pokeCachedId);
//   // const getCached = async () => {
//   //   let cachedUrls = cachedPoint?.map(item => item.url);
//   //   try {
//   //     const resultResponse = await fetchDataFromUrls(cachedUrls);
//   //     setMergedAllData(resultResponse.map(result => result.data));
//   //   } catch (error) {
...
//   // useEffect(() => {
//   //   setPokeCachedId(mergedAllData[mergedAllData.length - 1]?.id);
//   //   localStorage.setItem('cachedPokemonData', JSON.stringify(pokeCachedId));
//   // }, [mergedAllData]);

//   // useEffect(() => {
//   //   const cachedId = localStorage.getItem('cachedPokemonData');
//   //   const cachedScrollPosition = localStorage.getItem('cachedScrollPosition');

//   //   if (cachedId !== null && cachedScrollPosition !== null) {
//   //     setPokeCachedId(JSON.parse(cachedId));
...
//     // 로컬에 저장
//     localStorage.setItem('cachedScrollPosition', window.scrollY.toString());
//   };
